...
/**
 * Log in component for admin panel 
 *  Renders a login form & handles admin authentication
 * @component
...
const Login = () => {
    ...
    const onSubmitHandler = async (e) => {
         ...
         * Sends a POST request with email & password to connect with  backend API
         * 
         * @async
        ...
        try {
            ...
            console.log(response);  //success handling logic
