...
/**
 * Sidebar component that provides navigation links to different admin routes
 * 
 * @component
 * @returns {JSX.Element} Sidebar UI with links to Add Items, List Items and orders
 */
