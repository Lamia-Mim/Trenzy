 ...
 * 
 * @description
 * Dsplays the items currently in the user'scart, includiing product details with quantity controls
 * quantity selectors, and view cart total section with a checkout button
 * 
 * Retrieves cart data from the global 'shopContext'
 * 
 * @component
 * @reurns {JSX.Element} The cart page UI
 */
...
const cart = () => {
    ...
    /**
     * Updates the 'cartData' array whenever 'cartItems' changes
     */
